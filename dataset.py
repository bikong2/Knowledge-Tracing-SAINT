...
class DKTDataset(Dataset):
  ...
  def __getitem__(self,idx):
    ...
    seq_len = len(content_ids) # 某一具体样本序列的长度
    ...
    target_qids = q_ids[1:] # target和input错开一位
    label = ans[1:] 
    ...
    return inputs,target_qids,label 
...
def get_dataloaders():              
    ...
    print("no. of skills(qid) :",n_skills)
    print("no. of categories(task_container_id): ", n_cats)
